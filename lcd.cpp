...
//set ports A0-A3, B4, and B6 to output
void initLCDPins()
{
  // pins on lcd
...
//function to call 4 bit commands to LCD
...
//function to call 8 bit commands to LCD
...
//used to write a character on LCD
